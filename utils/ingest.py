...
# def index_documents(file_paths: List[str], save_index: bool = True):
#     """
#     Ingest a list of file paths (pdf or txt), chunk, embed with Gemini, store FAISS index and metadata.
...
#             metadata.append({"doc_id": doc_name, "chunk_id": i, "text": c})
#             all_chunks.append(c)
...
#     # normalize for cosine-like similarity (use Inner Product index after normalization)
